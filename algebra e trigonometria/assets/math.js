/* ============================================================================
   ...
   Blocco "Algebra e Trigonometria": insiemi numerici, valore assoluto, unità
   immaginaria, operatori. Le macro vettori/matrici servono ai capitoli su
   vettori, matrici e determinanti; gli evidenziatori all'anatomia delle formule.
   ========================================================================= */
window.MathJax = {
  tex: {
    inlineMath: [["\\(", "\\)"], ["$", "$"]],
